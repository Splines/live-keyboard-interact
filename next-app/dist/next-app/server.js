...
const config_json_1 = __importDefault(require("../init-app/config.json"));
...
nextApp.prepare().then(() => {
    ...
    httpServer.listen(`${config_json_1.default.server.port}`, () => {
        console.log(`listening on ${config_json_1.default.accessPoint.ipStatic}:${config_json_1.default.server.port}/`);
    });
});
// Old
